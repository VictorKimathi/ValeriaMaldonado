...
const testimonials: Testimonial[] = [
  {
    ...
    quote:
      "Valeria consistently delivers features that strike the perfect balance between inspiration and practical detail. Her work on eco-friendly travel content helped expand our readership and positioned us strongly in sustainable travel coverage.",
    initials: 'CH',
    rating: 5,
    location: 'Remote'
  },
  {
    ...
    quote:
      "Her stories are vivid, accessible, and always impeccably researched. Valeria is one of those rare writers who can take complex cultural topics and make them engaging for broad audiences without losing depth.",
    initials: 'DR',
    rating: 5,
    location: 'Remote'
  },
  {
    ...
    quote:
      "Working with Valeria was a pleasure. Her destination profiles consistently exceeded expectations, combining creativity with accuracy. She has an innate ability to capture the feel of a place in a way that inspires our readers to explore.",
    initials: 'SB',
    rating: 4,
    location: 'Remote'
  }
      ...
      <div className="container mx-auto px-4 md:px-6 relative">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-stone-600 max-w-3xl mx-auto">
              Reflections from editors and publishers who have collaborated with Valeria.
            </p>
          </div>
          ...
          <div className="relative h-[450px] md:h-[400px] overflow-hidden">
            <AnimatePresence custom={direction} mode="wait">
              ...
              >
                <div className="bg-white rounded-xl shadow-xl overflow-hidden max-w-4xl mx-auto grid md:grid-cols-2">
                  {/* Image / Initials side */}
                  <div className="relative h-64 md:h-full flex items-center justify-center bg-amber-50">
                    {currentTestimonial.image ? (
                      ...
                      <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-amber-400 to-teal-400">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-6">
                      ...
                      <p className="text-white text-sm">{currentTestimonial.location}</p>
                    </div>
                  </div>
          ...
          <div className="flex justify-center mt-8 items-center gap-4">
            <button
              ...
              className="p-2 rounded-full bg-white shadow-md text-stone-600 hover:text-amber-600 transition-colors"
